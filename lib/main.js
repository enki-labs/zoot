                ...
                var findChildren = function (task, newTags, findExistingChildren, refCounter) { return function (err, parentData) {
                    ...
                    var processChildren = function (task, newTags, refCounter) { return function (err, existingChildren) {
                        ...
                        for (existingIndex in existingChildren.data) 
                        {
                            ...
                            console.log(existingChild.data.tag.constructor.name);
                            var existingTags = typeof existingChild.data.tag == "string" ? JSON.parse(existingChild.data.tag) : existingChild.data.tag.get();
                            console.log("-------------------------------");
                            ...
                            console.log("-----");
                            console.log(existingChild.data.tag.join(","));
                            console.log("==");
                            console.log(newTags.toString());
                            console.log((existingTags.join(",") == newTags.toString()));
                            console.log("-------------------------------");
                            if (existingChild.data.query == query && existingTags.join(",") == newTags.toString())
                            {
